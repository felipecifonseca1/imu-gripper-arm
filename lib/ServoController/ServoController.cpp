...
ServoController::ServoController() 
    : _currentRoll(0.0), _currentPitch(0.0), _alpha(0.2), _deadband(2.0) {
}

void ServoController::init(int gripperPin, int elevationPin) {
...
void ServoController::update(float targetRoll, float targetPitch) {
    ...
    // Assuming IMU gives roll/pitch from -90 to 90 degrees
